...
function fileReader(csvFilePath){
  // YOUR CODE HERE
  var data=fs.readFileSync('./investments1.csv', { encoding : 'utf8'});
  var options = {
  	delimiter : ',', // optional
  	//quote     : '"' // optional
  };
...
function parser(arr){
  ...
  arr.forEach(function(element){
  	//console.log(element)
  	element.originalInvestment=Number(element.originalInvestment);
  	element.valueToday=Number(element.valueToday);
  })
  return arr;
